package net.starliteheart.cobbleride.mod.neoforge.client;
...
import net.starliteheart.cobbleride.mod.common.client.gui.RideStaminaOverlay;
import net.starliteheart.cobbleride.mod.common.client.keybind.CobbleRideKeyBinds;
