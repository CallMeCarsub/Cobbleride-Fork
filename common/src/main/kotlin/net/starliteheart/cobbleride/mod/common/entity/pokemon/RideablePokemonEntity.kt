package net.starliteheart.cobbleride.mod.common.entity.pokemon
...
import net.starliteheart.cobbleride.mod.common.net.messages.client.pokemon.ai.ClientMoveBehaviour
import net.starliteheart.cobbleride.mod.common.net.messages.client.pokemon.update.RidePokemonStateUpdatePacket
import net.starliteheart.cobbleride.mod.common.net.messages.client.spawn.SpawnRidePokemonPacket
import net.starliteheart.cobbleride.mod.common.pokemon.RideableFormData
import net.starliteheart.cobbleride.mod.common.pokemon.RiderOffsetType
import net.starliteheart.cobbleride.mod.common.pokemon.RiderOffsetType.*
import net.starliteheart.cobbleride.mod.common.util.averageOfTwoRots
import net.starliteheart.cobbleride.mod.common.util.emitParticle
import net.starliteheart.cobbleride.mod.common.util.rotateVec3
    ...
    override fun tickRidden(player: Player, vec3: Vec3) {
        ...
        if (canSprint && (!isInWater || canSprintInWater) && (!isFlying() || canSprintInAir)
            ...
            if (sprintStaminaScale > 0) {
                ...
                // This may not be the best way to get an FOV change, but this will suffice until the inevitable bugs first happen
