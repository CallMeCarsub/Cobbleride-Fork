package net.starliteheart.cobbleride.mod.common.client.keybind

import com.cobblemon.mod.common.client.keybind.CobblemonKeyBinding
import com.cobblemon.mod.common.platform.events.PlatformEvents
import net.minecraft.client.KeyMapping
import net.starliteheart.cobbleride.mod.common.client.keybind.keybinds.AscendBinding
import net.starliteheart.cobbleride.mod.common.client.keybind.keybinds.DescendBinding
import net.starliteheart.cobbleride.mod.common.client.keybind.keybinds.SprintBinding
